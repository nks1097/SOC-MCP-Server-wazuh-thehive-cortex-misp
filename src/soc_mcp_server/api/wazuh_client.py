...
from soc_mcp_server.api.wazuh_indexer import IndexerNotConfiguredError, WazuhIndexerClient
from soc_mcp_server.config import WazuhConfig
from soc_mcp_server.resilience import CircuitBreaker, CircuitBreakerConfig, RetryConfig
...
class WazuhClient:
    ...
    async def _get_cached(self, cache_key: str, endpoint: str, **kwargs) -> Dict[str, Any]:
        ...
        """
        from soc_mcp_server.monitoring import record_cache_access
