#!/usr/bin/env python3
"""
Production monitoring, metrics, and observability for SOC MCP Server
...
SERVER_INFO = Info("soc_mcp_server_info", "Server information", registry=REGISTRY)
...
async def check_wazuh_connectivity():
    ...
    try:
        from soc_mcp_server.server import get_wazuh_client
...
async def check_session_store() -> Dict[str, Any]:
    ...
    try:
        from soc_mcp_server.server import sessions
