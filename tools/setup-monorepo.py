#!/usr/bin/env python3
"""
SOC MCP Server - Monorepo Setup Tool
...
class MonorepoConverter:
    """Converts SOC MCP Server to monorepo architecture."""
    ...
    def extract_core_components(self):
        ...
        src_dir = Path("src/soc_mcp_server")
...
[project.urls]
Homepage = "https://github.com/nks1097/SOC-MCP-Server"
Repository = "https://github.com/nks1097/SOC-MCP-Server"
...
[project.scripts]
soc-mcp-server = "wazuh_mcp_stdio.main:main"
...
from soc_mcp_server.analyzers.security_analyzer import SecurityAnalyzer
